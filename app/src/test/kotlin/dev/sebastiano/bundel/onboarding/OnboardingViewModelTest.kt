...
internal class OnboardingViewModelTest {
    ...
    inner class PreferenceDefaults {
        ...
        @Test
        internal fun `should emit the default days schedule and no dolphins`() = runTest {
        ...
        @Test
        internal fun `should emit the default time ranges schedule`() = runTest {
        ...
        @Test
        internal fun `should emit false for crash reporting`() = runTest {
